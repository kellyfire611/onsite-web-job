...
$conn = @mysqli_connect(Config::$DB_CONNECTION_HOST, Config::$DB_CONNECTION_USERNAME, Config::$DB_CONNECTION_PASSWORD, Config::$DB_CONNECTION_DATABASE_NAME) or die('Xin lỗi, không kết nối được cơ sở dữ liệu.');
